...
public class CameraManualControl {
    ...
    public static Exposure[] EXPOSURE_LINE = new Exposure[] {
            ...
            Exposure.Create(SHUTTER_SPEED.EXPOSURE_1_25, ISO.ISO_1000),
            Exposure.Create(SHUTTER_SPEED.EXPOSURE_1_20, ISO.ISO_1000),
            Exposure.Create(SHUTTER_SPEED.EXPOSURE_1_15, ISO.ISO_1000),
            Exposure.Create(SHUTTER_SPEED.EXPOSURE_1_13, ISO.ISO_1000),
            Exposure.Create(SHUTTER_SPEED.EXPOSURE_1_10, ISO.ISO_1000),
            Exposure.Create(SHUTTER_SPEED.EXPOSURE_1_8,  ISO.ISO_1000),
            Exposure.Create(SHUTTER_SPEED.EXPOSURE_1_8,  ISO.ISO_1250),
            Exposure.Create(SHUTTER_SPEED.EXPOSURE_1_8,  ISO.ISO_1600),
            Exposure.Create(SHUTTER_SPEED.EXPOSURE_1_8,  ISO.ISO_2000),
            Exposure.Create(SHUTTER_SPEED.EXPOSURE_1_8,  ISO.ISO_2500),
